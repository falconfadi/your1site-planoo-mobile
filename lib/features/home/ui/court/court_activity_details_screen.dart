...
class CourtActivityDetailsScreen extends StatelessWidget {

  const CourtActivityDetailsScreen({super.key});
                  ...
                  child: PopupMenuButton(
                    ...
                    itemBuilder: (BuildContext context) => [
                      PopupMenuItem(
                          ...
                          onTap: () =>  Navigation.push(CourtCreateActivityScreen(isEdit: true))
                      ),
                      PopupMenuItem(
                          value: "",
                          height: 50.h,
