...
class CourtWorkdayDetailsScreen extends StatelessWidget {

  const CourtWorkdayDetailsScreen({super.key});
                  ...
                  child: PopupMenuButton(
                    ...
                    itemBuilder: (BuildContext context) => [
                      PopupMenuItem(
                          ...
                          onTap: () => Navigation.push(CourtCreateWorkdayScreen(isEdit: true))
                      ),
                      PopupMenuItem(
                          value: "",
                          height: 50.h,
