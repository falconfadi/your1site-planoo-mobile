...
class TrainerCreateActivityScreen extends StatefulWidget {

  bool? isEdit;

  TrainerCreateActivityScreen({super.key,this.isEdit = false});

  @override
  State<TrainerCreateActivityScreen> createState() => _TrainerCreateActivityScreenState();
}

class _TrainerCreateActivityScreenState extends State<TrainerCreateActivityScreen>  with FormStateMinxin {
