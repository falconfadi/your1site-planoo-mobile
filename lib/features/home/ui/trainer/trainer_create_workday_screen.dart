...
class TrainerCreateWorkdayScreen extends StatefulWidget {

  bool? isEdit;

  TrainerCreateWorkdayScreen({super.key,this.isEdit = false});

  @override
  State<TrainerCreateWorkdayScreen> createState() => _TrainerCreateWorkdayScreenState();
}

class _TrainerCreateWorkdayScreenState extends State<TrainerCreateWorkdayScreen> {
