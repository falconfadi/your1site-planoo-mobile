...
import 'package:centro_partner/features/home/ui/court/court_workday_details_screen.dart';
import 'package:centro_partner/features/home/ui/court/court_create_workday_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

class CourtWorkdayWidget extends StatelessWidget {

  const CourtWorkdayWidget({super.key});
    ...
    return Dismissible(
        ...
        confirmDismiss: (direction) async {
          if (direction == DismissDirection.startToEnd) {
            ...
            Navigation.push(CourtCreateWorkdayScreen(isEdit: true));
            return false;
          }
          return false;
        },
        ...
        child: InkWell(
          onTap: () => Navigation.push(CourtWorkdayDetailsScreen()),
          child: Container(
            width: 1.sw,
