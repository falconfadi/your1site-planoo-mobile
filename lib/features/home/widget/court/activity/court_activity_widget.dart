...
import 'package:centro_partner/features/home/ui/court/court_activity_details_screen.dart';
import 'package:centro_partner/features/home/ui/court/court_create_activity_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:flutter_svg/flutter_svg.dart';

class CourtActivityWidget extends StatelessWidget {

  const CourtActivityWidget({super.key});
    ...
    return Dismissible(
        ...
        confirmDismiss: (direction) async {
          if (direction == DismissDirection.startToEnd) {
            ...
            Navigation.push(CourtCreateActivityScreen(isEdit: true));
            return false;
          }
          return false;
        },
        ...
        child: InkWell(
          onTap: () => Navigation.push(CourtActivityDetailsScreen()),
          child: Container(
            width: 1.sw,
