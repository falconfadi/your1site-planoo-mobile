...
class AppointmentDetailsScreen extends StatefulWidget {
  ...
  AppointmentDetailsScreen({super.key,this.page,required this.appointmentId,this.onRefresh});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              if(widget.page == "notification") {
                Navigation.pushAndRemoveUntil(NavBarScreen(pageIndex: 2));
              } else {
                Navigation.pop();
              }
            },
        ...
        body: PopScope(
          ...
          child: GetModel<AppointmentDetailsModel>(
