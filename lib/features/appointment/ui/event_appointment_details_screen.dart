...
class EventAppointmentDetailsScreen extends StatefulWidget {
  ...
  EventAppointmentDetailsScreen({super.key,required this.eventModel,required this.appointment,this.onRefresh});
              ...
              InkWell(
                onTap: () {
                  Navigation.push(EventDetailsScreen(
                    eventId: widget.eventModel.event!.iD!,
                  ));
                },
                child: Card(
                    ...
                    child: Column(
                      ...
                      children: [
                        CachedImage(
                          width: 1.sw,
                          height: 180.h,
                          imageUrl: widget.eventModel.event!.mediaList!.isNotEmpty ?
                          widget.eventModel.event!.mediaList!.first.url! : "",
                          fit: BoxFit.cover,
                          borderRadius: 10.r,
                        ),
                        SizedBox(height: 10.h),
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(widget.eventModel.event!.name!,
                                  maxLines: 2,overflow: TextOverflow.ellipsis,
                                  style: AppTheme.headlineMedium),
                            ),
                            SizedBox(width: 10.w),
                            Text(widget.eventModel.event!.admissionFee.toString(),
                        ...
                        Row(
                          ...
                          children: [
                            Flexible(
                              child: Text(widget.eventModel.event!.category!.name!,
                                  maxLines: 2,overflow: TextOverflow.ellipsis,
